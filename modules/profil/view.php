          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">
                <?php
                if ($data['foto'] == "") { ?>
                  <img style="border:1px solid #eaeaea;border-radius:50%; box-shadow: 0 4px 6px rgba(0,0,0,0.1);"
              ...
              <label style="font-size:24px;margin-top:10px;" class="col-sm-8"><?php echo $data['nama_user']; ?></label>
            </div>
            <hr>
            <div class="form-group">
          ...
          <div class="box-footer">
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <input type="submit" class="btn btn-primary" name="ubah" value="Ubah Profil">
              </div>
            </div>
          </div>
        </form>
